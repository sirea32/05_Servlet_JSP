...
<head>
  ...
  <%-- webapp폴더 내부에 존재하는 css파일 요청해서 얻어오기 --%>
...
<body>
  ...
  <pre>
    ...
    * src/main/webapp
      ...
      forward시 JSP 파일 경로 / : webapp 폴더 기준
    ...
    * src/main/webapp/WEB-INF 폴더
      ...
      - 이럴꺼면 배포하는 webapp폴더에 안넣으면 되는거 아닌가?
        -> 직접 해당 파일을 보여줄 순 없지만
  ...
  <pre>
    ...
    - 존재하지 않는 경우
      -> "000님은 존재하지 않습니다"
          ...
          "/" (메인페이지 == index.jsp)로 재요청(redirect)하여 출력
  </pre>
